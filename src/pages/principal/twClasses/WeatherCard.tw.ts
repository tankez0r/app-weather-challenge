export const twObject = {
    ...
    citySelectedName: "relative font-bold  left-[1%] text-3xl max-w-fit lg:left-[30%]",
    maxMinContainer: "absolute bottom-0",
    maxMinText: "relative bottom-[43%] pl-1 text-l font-semibold"
}
